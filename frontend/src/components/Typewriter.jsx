...
const Typewriter = ({ text, typingSpeed = 100, color = "bg-white", is_cv = false, background = true, padding = false}) => {
  ...
  return (
    <div className={`${is_cv && "color-green-200"} ${background && color} ${background && "shadow-sm rounded-md"} animate-fadeInUp whitespace-pre-wrap ${padding && "px-4"} overflow-hidden`}>
